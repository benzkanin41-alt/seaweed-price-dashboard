...
5. ผู้ใช้ขอให้เป็น local dashboard จึงต้องเปิดผ่าน local URL ได้ เช่น `http://127.0.0.1:8768/outputs/seaweed_cost_dashboard.html`
...
Dashboard latest period: 2026-08
